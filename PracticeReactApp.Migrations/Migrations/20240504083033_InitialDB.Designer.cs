...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.Apiendpoint", b =>
                {
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.Menu", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.RoleApiendpoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.RoleMenu", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        new
                        {
                            Id = "000000",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a31e4c81-16af-4289-b3ad-06bc33d750a2",
                            ...
                            SecurityStamp = "600f3f56-31ca-425a-a960-2e534d574458",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PracticeReactApp.Core.Data.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PracticeReactApp.Core.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.RoleApiendpoint", b =>
                {
                    b.HasOne("PracticeReactApp.Core.Data.Entities.Apiendpoint", "ApicodeNavigation")
                        .WithMany("RoleApiendpoints")
                        .HasForeignKey("Apicode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PracticeReactApp.Core.Data.Entities.Role", "Role")
                        .WithMany("RoleApiendpoints")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PracticeReactApp.Core.Data.Entities.RoleMenu", b =>
                {
                    b.HasOne("PracticeReactApp.Core.Data.Entities.Menu", "MenuCodeNavigation")
                        .WithMany("RoleMenus")
